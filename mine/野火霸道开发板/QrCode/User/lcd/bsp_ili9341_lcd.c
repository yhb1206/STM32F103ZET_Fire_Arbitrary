 ...
 * @retval 无
 */
void QrCode(uint16_t usX, uint16_t usY, uint16_t usWidth, uint16_t usHeight)
{
	u08 i;
	u08 j;
	
	ILI9341_Clear(usX,usY,usWidth,usHeight);	/* 仅清除QR窗口部分，显示全黑 */
